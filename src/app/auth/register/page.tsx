  ...
  if (success) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-white px-4 py-12 relative overflow-hidden">
        ...
        <div
          className="absolute top-0 right-0 w-80 h-80 translate-x-1/3 -translate-y-1/3 rounded-full opacity-10"
        ...
        <div className="w-full max-w-md relative z-10 text-center">
          ...
          <BauhausCard padding="lg" accentColor="yellow" hasCornerAccent>
            <div
              className="w-16 h-16 rounded-full border-[3px] border-black mx-auto mb-4 flex items-center justify-center"
            ...
            <h2 className="text-bauhaus-subheading mb-2">
          ...
          <form onSubmit={handleRegister} className="space-y-5">
            ...
            <div className="flex items-start gap-3">
              <input
                ...
                type="checkbox"
                required
                className="mt-1 w-5 h-5 border-[2px] border-black accent-[var(--bauhaus-blue)]"
              />
              <label htmlFor="terms" className="text-sm text-gray-700">
                Elfogadom az{' '}
                <Link href="/aszf" className="text-[var(--bauhaus-blue)] hover:underline font-medium">
                  Általános Szerződési Feltételeket
                </Link>{' '}
                és az{' '}
                <Link href="/adatvedelem" className="text-[var(--bauhaus-blue)] hover:underline font-medium">
