...
import { AdatvedelemContent } from '@/components/legal'

export const metadata: Metadata = {
  title: 'Adatkezelési és Cookie Tájékoztató',
  description: 'A StudyU Fotóstúdió adatkezelési és cookie (süti) tájékoztatója.',
}
      ...
      <div className="relative overflow-hidden py-12 sm:py-24 lg:py-32">
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8 relative z-10">
          <div className="mx-auto max-w-2xl text-center">
            <h1 className="text-bauhaus-display mb-4">Adatkezelési és Cookie Tájékoztató</h1>
