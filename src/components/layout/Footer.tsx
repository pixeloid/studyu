  ...
  return (
    <footer className="bg-black text-white border-t-[3px] border-black">
      <div className="mx-auto max-w-7xl px-6 py-12 lg:px-8">
        {/* Top section with logo and geometric decoration */}
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-8 mb-12">
          ...
          <div className="hidden lg:flex items-center gap-4">
            <div
              className="w-16 h-16 rounded-full border-[3px] border-white opacity-20"
            />
            <div
              className="w-8 h-8 border-[3px] border-[var(--bauhaus-red)]"
            ...
            <div
              ...
              style={{
                ...
                borderBottom: '35px solid var(--bauhaus-blue)',
                opacity: 0.3,
              }}
            />
          </div>
        ...
        {/* Bottom bar */}
        <div className="border-t-[2px] border-gray-800 pt-8">
          <p className="text-center text-xs text-gray-500 font-bugrino uppercase tracking-wider">
            &copy; {new Date().getFullYear()} StudyU Fotóstúdió. Minden jog fenntartva.
          </p>
        </div>
      </div>
    </footer>
